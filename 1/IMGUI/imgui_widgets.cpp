...
bool ImGui::ButtonExes(const char* name, bool boolean)
{
    ...
    const ImRect rect(pos, ImVec2(pos.x + 190, pos.y + 35));
    ...
    window->DrawList->AddRectFilled(rect.Min, rect.Max, ImColor(0 / 255.0f, 0 / 255.0f, 0 / 255.0f, it_anim->second.rect_opacity), 6.0f);
